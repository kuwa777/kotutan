 ...
 *    - build-deploy.js により 1.0.20260909-230843 プレースホルダーへタイムスタンプが自動注入され、
...
export const APP_VERSION = '1.0.20260909-230843';
...
export async function checkAndApplyUpdates() {
    ...
    try {
        ...
        if (APP_VERSION !== '1.0.20260909-230843' && remoteVersion !== APP_VERSION) {
