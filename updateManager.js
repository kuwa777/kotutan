 ...
 *    - build-deploy.js により 1.0.20260912-023314 プレースホルダーへタイムスタンプが自動注入され、
...
export const APP_VERSION = '1.0.20260912-023314';
...
export async function checkAndApplyUpdates() {
    ...
    try {
        ...
        if (APP_VERSION !== '1.0.20260912-023314' && remoteVersion !== APP_VERSION) {
