 ...
 *    - build-deploy.js により 1.0.20260912-132054 プレースホルダーへタイムスタンプが自動注入され、
...
export const APP_VERSION = '1.0.20260912-132054';
...
export async function checkAndApplyUpdates() {
    ...
    try {
        ...
        if (APP_VERSION !== '1.0.20260912-132054' && remoteVersion !== APP_VERSION) {
