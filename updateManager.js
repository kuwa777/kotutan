 ...
 *    - build-deploy.js により 1.0.20260910-020554 プレースホルダーへタイムスタンプが自動注入され、
...
export const APP_VERSION = '1.0.20260910-020554';
...
export async function checkAndApplyUpdates() {
    ...
    try {
        ...
        if (APP_VERSION !== '1.0.20260910-020554' && remoteVersion !== APP_VERSION) {
