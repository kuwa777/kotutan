 ...
 *    - build-deploy.js により 1.0.20260911-000700 プレースホルダーへタイムスタンプが自動注入され、
...
export const APP_VERSION = '1.0.20260911-000700';
...
export async function checkAndApplyUpdates() {
    ...
    try {
        ...
        if (APP_VERSION !== '1.0.20260911-000700' && remoteVersion !== APP_VERSION) {
