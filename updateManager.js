 ...
 *    - build-deploy.js により 1.0.20260908-214737 プレースホルダーへタイムスタンプが自動注入され、
...
export const APP_VERSION = '1.0.20260908-214737';
...
export async function checkAndApplyUpdates() {
    ...
    try {
        ...
        if (APP_VERSION !== '1.0.20260908-214737' && remoteVersion !== APP_VERSION) {
