 ...
 *    - build-deploy.js により 1.0.20260910-002204 プレースホルダーへタイムスタンプが自動注入され、
...
export const APP_VERSION = '1.0.20260910-002204';
...
export async function checkAndApplyUpdates() {
    ...
    try {
        ...
        if (APP_VERSION !== '1.0.20260910-002204' && remoteVersion !== APP_VERSION) {
